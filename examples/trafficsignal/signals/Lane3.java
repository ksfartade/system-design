...
public class Lane3 implements Signal {
    private static final Lane3 instance = new Lane3();
    private static Signal nextLane = Lane4.getInstance();
    public static Lane3 getInstance(){
        return instance;
    }
    ...
    @Override
    public void execute(){
        System.out.println("At signal 3");
    ...
    public static void setGreenTime(int greenTime) {
        Lane3.greenTime = greenTime;
    }

    public static void setOrangeTime(int orangeTime) {
        Lane3.orangeTime = orangeTime;
    }
